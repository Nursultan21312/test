...
def main_page(page:ft.Page):
    ...
    with open("history.txt", "r") as file:
        for line in file.readlines():
            greeting_history.append(line)

    
    like_text = ft.Text("Избранные" + greeting_history[-1])
    like_list = []
    ...
    page.add(greeting_text , name_input , input_button_text ,theme_mode_button, clear_button,like_button, history_text )
